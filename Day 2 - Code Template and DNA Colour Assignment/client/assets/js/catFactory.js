...
function eyeVariation(num) {
    ...
    switch (num) {
        ...
        break
        default:
            console.log("eyeVariation(num): Unknown num")
        break
    }
}
...
function decorationVariation(num) {
    ...
    switch (num) {
        ...
        case 10:
            ...
            break 
        default:
            console.log("decorationVariation(num): Unknown num")
        break                               
    }
}
...
function normaldecoration() {
    ...
    // $('[class^="cat__head-dots"]').css({ "transform": "rotate(0deg)", "width": "14px", "top": "1px", "border-radius": "0 0 50% 50%" })
    // $('.cat__head-dots').css({ "height": "48px", "left": "101" })
    // $('.cat__head-dots_first').css({ "height": "35px", "left": "-20px"})
    // $('.cat__head-dots_second').css({ "height": "35px", "left": "20px" })
}
